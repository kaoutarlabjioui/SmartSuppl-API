...
import org.smartsupply.dto.request.ShipmentRequestDto;
...
public interface SalesOrderService {
    ...
    Page<SalesOrderResponseDto> listAll(String status, Long clientId, LocalDateTime startDate, LocalDateTime endDate,
            Pageable pageable);
    ...
    void planShipment(Long orderId, ShipmentRequestDto shipmentRequest);
